...
public class PaperBallBehaviour: MonoBehaviour
{
	...
	public int LimitXlow,LimitXhigh,LimitYlow,LimitYhigh,LimitZlow,LimitZhigh;
	...
	void OnGUI()
	{
		GUI.Label(new Rect(10,8,200,30), "PAPERBALL MODE!",MyStyle);
		GUI.Label(new Rect(10,35,200,40), "Score: " + PaperBallScorer.PlayerScore,MyStyle);
